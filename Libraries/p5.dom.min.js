...
! function(t, e) { "function" == typeof define && define.amd ? define("p5.dom", ["p5"], function(t) { e(t) }) : "object" == typeof exports ? e(require("./p5")) : e(t.p5) }(this, function(d) {
    ...
    function i(t, e, i, n) {
        ...
        var a = c(r, t, !0);
        return a.loadedmetadata = !1, r.addEventListener("loadedmetadata", function() { a.width = r.videoWidth, a.height = r.videoHeight, 0 === a.elt.width && (a.elt.width = r.videoWidth), 0 === a.elt.height && (a.elt.height = r.videoHeight), a.presetPlaybackRate && (a.elt.playbackRate = a.presetPlaybackRate, delete a.presetPlaybackRate), a.loadedmetadata = !0 }), a
        ...
        var e, i = arguments;
        return t.src = i[0], 1 < i.length && "string" == typeof i[1] && (t.alt = i[1]), t.onload = function() { e.width = t.offsetWidth || t.width, e.height = t.offsetHeight || t.height, 1 < i.length && "function" == typeof i[1] ? (e.fn = i[1], e.fn()) : 1 < i.length && "function" == typeof i[2] && (e.fn = i[2], e.fn()) }, e = c(t, this)
    }, d.prototype.createA = function(t, e, i) { d._validateParameters("createA", arguments); var n = document.createElement("a"); return n.href = t, n.innerHTML = e, i && (n.target = i), c(n, this) }, d.prototype.createSlider = function(t, e, i, n) { d._validateParameters("createSlider", arguments); var r = document.createElement("input"); return r.type = "range", r.min = t, r.max = e, 0 === n ? r.step = 1e-18 : n && (r.step = n), "number" == typeof i && (r.value = i), c(r, this) }, d.prototype.createButton = function(t, e) { d._validateParameters("createButton", arguments); var i = document.createElement("button"); return i.innerHTML = t, e && (i.value = e), c(i, this) }, d.prototype.createCheckbox = function() {
        ...
        if (i.checked = function() {
                ...
                return i
            }, this.value = function(t) { return i.value = t, this }, arguments[0]) {
        ...
        "object" == typeof t ? (n = t, r = this.elt = t.elt) : (r = document.createElement("div"), n = c(r, this)), n._getInputChildrenArray = function() { return Array.prototype.slice.call(this.elt.children).filter(function(t) { return "INPUT" === t.tagName }) };
        var h = -1;
        return n.option = function(t, e) {
            ...
            if (t) { for (e = 0; e < i.length; e++) i[e].value === t && (i[e].checked = !0); return this }
        ...
        o.setAttribute("playsinline", ""), t || (t = { video: e, audio: n }), navigator.mediaDevices.getUserMedia(t).then(function(e) {
            try { "srcObject" in o ? o.srcObject = e : o.src = window.URL.createObjectURL(e) } catch (t) { o.src = e }
            i && i(e)
        }, function(t) { console.log(t) });
        var s = c(o, this, !0);
        return s.loadedmetadata = !1, o.addEventListener("loadedmetadata", function() { o.play(), o.width ? (s.width = o.videoWidth = o.width, s.height = o.videoHeight = o.height) : (s.width = s.elt.width = o.videoWidth, s.height = s.elt.height = o.videoHeight), s.loadedmetadata = !0 }), s
    }, d.prototype.createElement = function(t, e) { d._validateParameters("createElement", arguments); var i = document.createElement(t); return void 0 !== e && (i.innerHTML = e), c(i, this) }, d.Element.prototype.addClass = function(t) { return this.elt.className ? this.hasClass(t) || (this.elt.className = this.elt.className + " " + t) : this.elt.className = t, this }, d.Element.prototype.removeClass = function(t) { return this.elt.classList.remove(t), this }, d.Element.prototype.hasClass = function(t) { return this.elt.classList.contains(t) }, d.Element.prototype.toggleClass = function(t) { return this.elt.classList.contains(t) ? this.elt.classList.remove(t) : this.elt.classList.add(t), this }, d.Element.prototype.child = function(t) { return void 0 === t ? this.elt.childNodes : ("string" == typeof t ? ("#" === t[0] && (t = t.substring(1)), t = document.getElementById(t)) : t instanceof d.Element && (t = t.elt), this.elt.appendChild(t), this) }, d.Element.prototype.center = function(t) {
        ...
        return this
    }, d.Element.prototype.attribute = function(t, e) { if (null == this.elt.firstChild || "checkbox" !== this.elt.firstChild.type && "radio" !== this.elt.firstChild.type) return void 0 === e ? this.elt.getAttribute(t) : (this.elt.setAttribute(t, e), this); if (void 0 === e) return this.elt.firstChild.getAttribute(t); for (var i = 0; i < this.elt.childNodes.length; i++) this.elt.childNodes[i].setAttribute(t, e) }, d.Element.prototype.removeAttribute = function(t) {
    ...
    }, d.Element.prototype.value = function() { return 0 < arguments.length ? (this.elt.value = arguments[0], this) : "range" === this.elt.type ? parseFloat(this.elt.value) : this.elt.value }, d.Element.prototype.show = function() { return this.elt.style.display = "block", this }, d.Element.prototype.hide = function() { return this.elt.style.display = "none", this }, d.Element.prototype.size = function(t, e) {
    ...
    }, d.MediaElement.prototype.time = function(t) { return void 0 === t ? this.elt.currentTime : (this.elt.currentTime = t, this) }, d.MediaElement.prototype.duration = function() { return this.elt.duration }, d.MediaElement.prototype.pixels = [], d.MediaElement.prototype._ensureCanvas = function() { this.canvas || this.loadPixels() }, d.MediaElement.prototype.loadPixels = function() {
    ...
    }, d.MediaElement.prototype.showControls = function() { this.elt.style["text-align"] = "inherit", this.elt.controls = !0 }, d.MediaElement.prototype.hideControls = function() { this.elt.controls = !1 };
    var o = function(t, e, i, n) { this.callback = t, this.time = e, this.id = i, this.val = n };
    ...
    }, d.MediaElement.prototype.clearCues = function() { this._cues = [], this.elt.ontimeupdate = null }, d.MediaElement.prototype._onTimeUpdate = function() {
